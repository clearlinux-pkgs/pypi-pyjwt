...
Source0  : https://files.pythonhosted.org/packages/fb/68/ce067f09fca4abeca8771fe667d89cc347d1e99da3e093112ac329c6020e/pyjwt-2.9.0.tar.gz
...
%prep
%setup -q -n pyjwt-2.9.0
cd %{_builddir}/pyjwt-2.9.0
pushd ..
cp -a pyjwt-2.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722635873
